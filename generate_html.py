def generate_html_from_videos(file_path="videos.txt", output_path="index.html"):
    try:
        ...
        <body>
            <!-- Audio Elements -->
            <audio id="sfx-logo-click" src="sfx2.mp3"></audio>
            <audio id="sfx-hover" src="sfx1.mp3" loop></audio>
            <audio id="sfx-typing" src="sfx3.mp3"></audio>

            <header>
                <a href="https://www.youtube.com/@Wyrmweave" target="_blank">
                    <img src="wyrmweave.png" alt="Wyrmweave Logo">
                </a>
                <h1>مرحبًا</h1>
            </header>
            <main>
